...
```
Since age is a continuous variable, we choose a split value, in this case 70, to classify the data into two groups for a contingency table. 
...
```
Since number of animals recalled is a continuous variable, we choose a split value, in this case 10, to classify the data into two groups. 
